        ...
        <div className="parent--snapper">
            ...
            <main className="snapped">
                ...
                <div className="main--socials">
                    ...
                    <a
                        href="mailto:zhaihongmeng@gmail.com"
                        className="main--socials-btn"
                    >
                        <MailBtn />
                    </a>
            ...
            <section className="biography snapped">
            ...
            <section className="blogs snapped">
